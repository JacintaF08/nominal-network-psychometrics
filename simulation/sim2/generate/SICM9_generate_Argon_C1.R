...
##
## Condition 1 — Article correlation (within-set r = 0.5):
...
##
##   Misconception sets:
##     Set 1: misconceptions 1, 4, 7  (correlated at r = 0.5)
##     Set 2: misconceptions 2, 5, 8  (correlated at r = 0.5)
##     Set 3: misconceptions 3, 6, 9  (correlated at r = 0.5)
##
...
##
## Usage (HPC array job):
##   Rscript SICM9_generate_Argon_C1.R <replication_number>
##
## Output:
##   Data/ResponseMatrix9_C1_{c}.RData
...
##   generated datasets are provided in data/simulation/sim2/condition1/.
##
...
# -----------------------------------------------------------------------------
# Step 1: Build 9x9 tetrachoric correlation matrix (within-set r = 0.5)
# -----------------------------------------------------------------------------
...
corr9_1 <- matrix(0, nrow = 9, ncol = 9)
diag(corr9_1) <- 1

# Set 1: misconceptions 1, 4, 7
corr9_1[1, c(4, 7)] <- corr9_1[c(4, 7), 1] <- 0.5
corr9_1[4, 7]       <- corr9_1[7, 4]        <- 0.5

# Set 2: misconceptions 2, 5, 8
corr9_1[2, c(5, 8)] <- corr9_1[c(5, 8), 2] <- 0.5
corr9_1[5, 8]       <- corr9_1[8, 5]        <- 0.5

# Set 3: misconceptions 3, 6, 9
corr9_1[3, c(6, 9)] <- corr9_1[c(6, 9), 3] <- 0.5
corr9_1[6, 9]       <- corr9_1[9, 6]        <- 0.5
...
continuousData  <- mvrnorm(n = nObsTC, mu = rep(0, nmisconceptions), Sigma = corr9_1)
...
save(itemResponse, latents, itemParameters, option_qmatrix, corr9_1, cutpoints,
     file = paste0("Data/ResponseMatrix9_C1_{", c, "}.RData"))
