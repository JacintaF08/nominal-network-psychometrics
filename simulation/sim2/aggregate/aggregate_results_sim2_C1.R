## =============================================================================
## Simulation 2: Aggregate Network Results (9 Misconceptions, Condition 1)
## =============================================================================
##
## Description:
##   Reads all 1,000 NetworkResults/rep{c}.RData files produced by
##   network9_estimate_Argon_C1.R and aggregates the per-replication group
##   average edge weights into combined vectors used to produce Table 3
##   and Figure 2B in the paper.
##
##   Run locally after all 1,000 HPC jobs for Condition 1 are complete.
##   Point RESULTS_DIR at the NetworkResults folder for Condition 1.
##
## Condition 1 — Within-set correlation r = 0.5
##
## Input:
##   NetworkResults/rep1.RData ... NetworkResults/rep1000.RData
##
## Output:
##   network_avgs9_1.RData
...
##
## Usage:
##   Set RESULTS_DIR to the path of the Condition 1 NetworkResults folder,
##   then run the full script.
##
## Dependencies: none (base R only)
## =============================================================================

RESULTS_DIR <- "NetworkResults"   # path to Condition 1 NetworkResults folder
N_REPS      <- 1000
...
save(avg_bothcorrect_9, avg_onecorrect_9, avg_samemis_9,
     ...
     file = "network_avgs9_1.RData")

cat("\nSaved: network_avgs9_1.RData\n")
