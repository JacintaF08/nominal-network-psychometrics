## =============================================================================
## Simulation 1: Aggregate Network Results (3 Misconceptions, Condition 3)
## =============================================================================
##
## Description:
##   Reads all 1,000 NetworkResults/rep{c}.RData files produced by
##   network3_estimate_Argon_C3.R and aggregates the per-replication group
...
save(avg_bothcorrect, avg_onecorrect, avg_samemis, avg_corrmis, avg_uncorrmis,
     ...
     file = "network_avgs3_3.RData")

cat("\nSaved: network_avgs3_3.RData\n")
