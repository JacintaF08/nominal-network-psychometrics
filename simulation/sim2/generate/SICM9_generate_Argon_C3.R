...
##
## Condition 3 — Low correlation (within-set r = 0.2):
...
##
##   Misconception sets:
##     Set 1: misconceptions 1, 4, 7  (correlated at r = 0.2)
##     Set 2: misconceptions 2, 5, 8  (correlated at r = 0.2)
##     Set 3: misconceptions 3, 6, 9  (correlated at r = 0.2)
##
...
##
## Usage (HPC array job):
##   Rscript SICM9_generate_Argon_C3.R <replication_number>
##
## Output:
##   Data/ResponseMatrix9_C3_{c}.RData
...
##   generated datasets are provided in data/simulation/sim2/condition3/.
##
...
# -----------------------------------------------------------------------------
# Step 1: Build 9x9 tetrachoric correlation matrix (within-set r = 0.2)
# -----------------------------------------------------------------------------
...
corr9_3 <- matrix(0, nrow = 9, ncol = 9)
diag(corr9_3) <- 1

# Set 1: misconceptions 1, 4, 7
corr9_3[1, c(4, 7)] <- corr9_3[c(4, 7), 1] <- 0.2
corr9_3[4, 7]       <- corr9_3[7, 4]        <- 0.2

# Set 2: misconceptions 2, 5, 8
corr9_3[2, c(5, 8)] <- corr9_3[c(5, 8), 2] <- 0.2
corr9_3[5, 8]       <- corr9_3[8, 5]        <- 0.2

# Set 3: misconceptions 3, 6, 9
corr9_3[3, c(6, 9)] <- corr9_3[c(6, 9), 3] <- 0.2
corr9_3[6, 9]       <- corr9_3[9, 6]        <- 0.2
...
continuousData  <- mvrnorm(n = nObsTC, mu = rep(0, nmisconceptions), Sigma = corr9_3)
...
save(itemResponse, latents, itemParameters, option_qmatrix, corr9_3, cutpoints,
     file = paste0("Data/ResponseMatrix9_C3_{", c, "}.RData"))
