## =============================================================================
## Simulation 2: Aggregate Network Results (9 Misconceptions, Condition 2)
## =============================================================================
##
## Description:
##   Reads all 1,000 NetworkResults/rep{c}.RData files produced by
##   network9_estimate_Argon_C2.R and aggregates the per-replication group
...
##
## Condition 2 — Within-set correlation r = 0.8 (high)
##
## Input:
##   NetworkResults/rep1.RData ... NetworkResults/rep1000.RData
##
## Output:
##   network_avgs9_2.RData
...
save(avg_bothcorrect_9, avg_onecorrect_9, avg_samemis_9,
     ...
     file = "network_avgs9_2.RData")

cat("\nSaved: network_avgs9_2.RData\n")
