...
##   from Simulation 2, Condition 1 (within-set r = 0.5). Estimates a
...
##
## Usage (HPC array job):
##   Rscript network9_estimate_Argon_C1.R <replication_number>
##
## Input:
##   Data/ResponseMatrix9_C1_{c}.RData  (from SICM9_generate_Argon_C1.R)
##
## Output:
...
load(paste0("Data/ResponseMatrix9_C1_{", c, "}.RData"))
