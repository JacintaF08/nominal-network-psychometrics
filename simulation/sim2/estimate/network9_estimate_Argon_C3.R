...
##   from Simulation 2, Condition 3 (within-set r = 0.2). Estimates a
...
##
## Usage (HPC array job):
##   Rscript network9_estimate_Argon_C3.R <replication_number>
##
## Input:
##   Data/ResponseMatrix9_C3_{c}.RData  (from SICM9_generate_Argon_C3.R)
##
## Output:
...
load(paste0("Data/ResponseMatrix9_C3_{", c, "}.RData"))
